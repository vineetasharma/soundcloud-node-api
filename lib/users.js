...
Users.prototype.getAllUsers = function (cb) {
    ...
    var url = Constants.BASE_URL.USERS + '?client_id=' + this.client_id;
...
Users.prototype.getUserDetails = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserTracks = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/tracks?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserPlaylists = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/playlists?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserFollowings = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/followings?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserFollowingUser = function (userId, followingId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/followings/" + followingId + "?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserFollowers = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/followers?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserFollowerUser = function (userId, followerId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/followers/" + followerId + "?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserComments = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/comments?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserFavorites = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/favorites?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserFavoriteTrack = function (userId, trackId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/favorites/" + trackId + "?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserGroups = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/groups?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
/**
...
Users.prototype.getUserWebProfiles = function (userId, cb) {
    ...
    if (!cb)
        throw new Error(Messages.ERROR.UNDEFINED_CALLBACK_URL);
    var url = Constants.BASE_URL.USERS + '/' + userId + "/web-profiles?client_id=" + this.client_id;
    Helper.getJsonData(url, cb);
};
